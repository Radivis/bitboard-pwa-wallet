...
export const article: LibraryArticle = {
  ...
  body: (
    <div className={ARTICLE_BODY_CLASS}>
      <p>
        Your keys control your bitcoin. Anyone who obtains a copy of your seed phrase, private keys,
        or wallet backup can potentially spend your funds. Treat backups like cash in a safe: limit
        copies, know where they are, and prefer offline storage for recovery material.
      </p>
      <p>
