          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href={githubUrl} target="_blank" rel="noopener noreferrer">
                ...
                >
                  VIEW GITHUB{' '}
                  <GitHubMark className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
              </a>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                ...
                instantly in your browser, then seamlessly install it as a native mobile app. Your journey to
                self-custody and Bitcoin mastery starts here!
              </p>
            ...
            <div className="relative aspect-square bg-matrix/5 border border-matrix/20 p-8 flex items-center justify-center group overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                <Cpu
                  size={80}
                  className="text-matrix mx-auto mb-4 drop-shadow-[0_0_15px_rgba(0,255,65,0.5)]"
                />
          ...
          <div className="bg-matrix/5 border border-matrix/20 p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed font-mono text-sm">
                ...
                <p>
                  &gt; A deep dive into the foundations of Bitcoin and Lightning revealed to me that most of the
                  potential of these breakthrough technologies remains untapped.
                </p>
                <p>
                ...
                <p>
                  &gt; Bitboard Wallet represents my best shot at demystifying the Bitcoin Matrix to those willing to
                  take that plunge.
                </p>
                <p>
