...
const DOMAIN_BY_BASENAME = {
  ...
  'infomode-hint-logic': 'shared',
  'infomode-primary-action-detect': 'shared',
  'infomode-suppression-feedback': 'shared',
  'kdf-phc-constants': 'shared',
  'legal-locale': 'shared',
  'opfs-capability': 'shared',
  'opfs-root-file': 'shared',
  'opfs-sqlite-replace-and-reload': 'shared',
...
const TEST_DOMAIN = {
  ...
  'infomode-hint-logic.test': 'shared',
  'infomode-primary-action-detect.test': 'shared',
  'infomode-suppression-feedback.test': 'shared',
  'isCoinbase.test': 'lab',
