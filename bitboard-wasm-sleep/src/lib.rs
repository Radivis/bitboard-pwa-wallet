//! WASM-only `Future` backed by browser `setTimeout`.
//!
//! Used by Esplora async clients in browser builds. Native host tests do not execute this path.
...
pub fn sleep_for(dur: Duration) -> WasmSleep {
